...
contract BunkerDealNotification is WorkbenchBase('BunkerDealNotification', 'BunkerDealNotification') {

     //Set of States
    enum StateType { Initiate,Nominate,Load,Accounting}
	...
	//Bunker loading
    function BunkerDealNotification(string Initiation) public
    {
        Marketer = msg.sender;
